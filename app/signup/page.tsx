...
export default function SignupPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    // In a real app, you'd integrate with an authentication service here
    console.log(values)
    ...
    setTimeout(() => {
      ...
      // Redirect to account setup based on account type
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 dark:bg-gray-950">
        ...
        <div className="mx-auto w-full max-w-md">
          <div className="flex justify-center">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-xl">FreelanceConnect</span>
            </Link>
          </div>
                      ...
                      <FormControl>
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            ...
                            <FormLabel htmlFor="freelancer" className="font-normal cursor-pointer">
      ...
      <div className="hidden lg:block relative w-0 flex-1">
        <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-blue-600 to-indigo-700 object-cover" />
        <div className="absolute inset-0 flex items-center justify-center p-10">
          <div className="max-w-lg text-white">
            <h2 className="text-4xl font-bold mb-6">Join FreelanceConnect Today</h2>
            <p className="text-xl mb-6">
              Connect with clients or find talented freelancers for your projects. Our platform makes it easy to work
            ...
            <ul className="space-y-2">
              ...
              <li className="flex items-center">
                ...
                Find perfect matches for your skills or needs
              </li>
              <li className="flex items-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
